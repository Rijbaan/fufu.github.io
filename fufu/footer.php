    ...
    <div class="row pt-100 pb-75">
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="footer-widget">
                <a href="index.html" class="footer-logo">
                    <img src="assets/img/wlf.png" alt="Image">
                </a>
                <p class="comp-desc">
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
            <div class="footer-widget">
                ...
                <p class="newsletter-text">Be a subscriber, this will help us to inform you about the new features.</p>
...
<div class="copyright-text">
    <p> <i class="ri-copyright-line"></i>2022 Fufu. All Rights Reserved By <a href="https://fufuinfo.com/" target="_blank">Fufu Info</a></p>
</div>
</footer>
